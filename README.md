...
The (higly stilised) procedure of the retreival augmented generation process can be visualized as follows:
![grafik_small](https://github.com/csiums/GRAGS/blob/main/documentation/grafik_small.jpg)
